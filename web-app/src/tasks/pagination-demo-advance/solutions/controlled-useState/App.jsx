...
function App() {
  ...
  // Handle page input submission (Enter key or button click)
  const handlePageInputSubmit = () => {
    const pageNumber = parseInt(pageInput)
    
    // Validate input
    if (isNaN(pageNumber) || pageNumber < 1 || pageNumber > totalPages) {
      setInputError(`Wprowadź liczbę z zakresu 1-${totalPages}`)
      return
    }
    
    // Navigate to the page
    setCurrentPage(pageNumber)
    console.log(`Strona: ${pageNumber}`)
  }
  ...
  return (
    <div className="container mt-4">
      <h2 className="mb-4">Demonstracja paginacji (Zaawansowana)</h2>
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              <div className="row align-items-center">
                ...
                <div className="col-md-3">
                  <label htmlFor="pageInput" className="form-label">
                    Przejdź do strony:
                  </label>
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              <ul className="list-unstyled mb-0">
                ...
                <li className="mb-2">
                  <strong>Przejdź do strony:</strong><br />
                  <small className="text-muted">Wprowadź numer strony (1-{totalPages}) i naciśnij Enter lub kliknij "Idź"</small>
                </li>
                <li className="mb-2">
