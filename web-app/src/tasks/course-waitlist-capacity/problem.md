# EGZAMIN ZAWODOWY — INF.04 (INF.04-Course-Waitlist-Capacity)
...
Wykonaj aplikację internetową typu front-end obsługującą zapisy na kursy z limitem miejsc z zastosowaniem dostępnego na stanowisku egzaminacyjnym frameworka Angular lub biblioteki React. Zastosuj bibliotekę Bootstrap do zdefiniowania stylu formularza.

---

### Obraz referencyjny

**Obraz 1b. Aplikacja React.js - Lista kursów z limitem miejsc**
![Obraz 1b](img/course-waitlist.png)
...
- Aplikacja web – dowolna liczba zrzutów nazwanych web1, web2 ... (np. stan początkowy, po wypełnieniu pól, po zatwierdzeniu konsola przeglądarki, gdy kurs ma dostępne miejsca oraz gdy kurs jest pełny)
