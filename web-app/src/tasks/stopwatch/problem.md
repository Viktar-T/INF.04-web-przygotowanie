# EGZAMIN ZAWODOWY — INF.04 (INF.04-STOPWATCH)
...
![Obraz 1b](img/stopwatch-preview.png)

Na obrazie 1b przedstawiono działanie aplikacji przygotowanej w środowisku React.js, stan po uruchomieniu stopera i zapisaniu kilku okrążeń.
