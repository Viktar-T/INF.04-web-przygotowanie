          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <div className="mb-3">
                ...
                <span className={`badge ms-2 ${hasNoCities ? 'bg-warning' : selectedCity ? 'bg-success' : 'bg-secondary'}`}>
      ...
      <div className="card mt-4">
        ...
        <div className="card-body">
          <p className="mb-0">
            ...
            <br />
            <code className="ms-1">{"{ country: \"Nazwa kraju\", city: \"Nazwa miasta\" }"}</code> - dla krajów z miastami
            <br />
            <code className="ms-1">{"{ country: \"Nazwa kraju\", city: null }"}</code> - dla krajów bez miast
            <br />
