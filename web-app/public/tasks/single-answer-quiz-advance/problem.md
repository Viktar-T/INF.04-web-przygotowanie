# EGZAMIN ZAWODOWY — INF.04 (INF.04-SINGLE-ANSWER-QUIZ-ADVANCE)
...
Wykonaj aplikację internetową typu front-end obsługującą quiz z jedną odpowiedzią z zaawansowanymi funkcjami (+20% trudności) z zastosowaniem dostępnego na stanowisku egzaminacyjnym frameworka Angular lub biblioteki React. Zastosuj bibliotekę Bootstrap do zdefiniowania stylu aplikacji.
...
- **Licznik prób** - śledzenie liczby prób odpowiedzi na pytanie
- **Persystencja danych** - zapisywanie licznika prób w `localStorage` i ładowanie przy starcie aplikacji
- **Reset licznika** - możliwość zresetowania licznika prób
...
- Aplikacja web – dowolna liczba zrzutów nazwanych web1, web2 ... (np. stan początkowy, po wybraniu poprawnej odpowiedzi, po naciśnięciu "Sprawdź" z poprawną odpowiedzią, po wybraniu błędnej odpowiedzi, po naciśnięciu "Sprawdź" z błędną odpowiedzią, stan konsoli przeglądarki z wyświetlonymi komunikatami, test funkcji zaawansowanych)
