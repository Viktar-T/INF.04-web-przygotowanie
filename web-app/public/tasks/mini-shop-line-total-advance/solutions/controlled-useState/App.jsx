...
function App() {
  ...
  useEffect(() => {
    const savedHistory = localStorage.getItem('shopTransactionHistory')
    if (savedHistory) {
      try {
  ...
  // Save transaction history to localStorage whenever history changes
  useEffect(() => {
    localStorage.setItem('shopTransactionHistory', JSON.stringify(transactionHistory))
  }, [transactionHistory])
  ...
  const handleAddToCart = (event) => {
    ...
    setTransactionHistory(prev => [...prev, transactionRecord])
  ...
  const clearTransactionHistory = () => {
    ...
    console.log("Historia transakcji wyczyszczona")
  }
          ...
          <div className="col-12">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center">
                <h5 className="card-title mb-0">Historia transakcji</h5>
                <button
                    ...
                    <tbody>
                      {transactionHistory.map((transaction, index) => (
                        <tr key={transaction.id}>
                          ...
                          <td>{transaction.lineTotal.toFixed(2)} zł</td>
