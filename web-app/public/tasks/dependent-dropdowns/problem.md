# EGZAMIN ZAWODOWY — INF.04 (INF.04-DEPENDENT-DROPDOWNS)
...
- Komponent wyświetla:
  - Nagłówek drugiego stopnia o treści: „Wybór kraju i miasta"
...
- Po kliknięciu przycisku „Wyślij" jest generowane zdarzenie, które:
  ...
  - Wyświetla w konsoli przeglądarki komunikat w formacie: `{ country: "Nazwa kraju", city: "Nazwa miasta" }`
  - Wyświetla komunikat o pomyślnym przesłaniu
- Lista miast jest wyłączona do momentu wyboru kraju
- Jeśli kraj nie ma dostępnych miast, wyświetlana jest odpowiednia informacja
...
- Aplikacja web – dowolna liczba zrzutów nazwanych web1, web2 ... (np. stan początkowy, po wybraniu kraju, po wybraniu miasta, po przesłaniu formularza, stan konsoli przeglądarki z wyświetlonymi komunikatami)
