...
function App() {
  // Static data - countries with their cities
  const countriesData = [
    {
      country: 'Polska',
  ...
  return (
    <div className="container mt-4">
      <h2 className="mb-4">Wybór kraju i miasta</h2>
        ...
        <div className="col-md-6">
          ...
          {showSuccessMessage && (
            <div className="alert alert-success" role="alert">
              ...
              <p className="mb-0">
                Wybrano: <strong>{selectedCountry}</strong> - <strong>{selectedCity}</strong>
              </p>
              <hr />
              <p className="mb-0">
            ...
            <div className="card-body">
              <ul className="list-unstyled mb-0">
                <li className="mb-2">
                  ...
                  <small className="text-muted">Z listy dostępnych krajów</small>
                </li>
                <li className="mb-2">
                  <strong>2. Wybierz miasto:</strong><br />
                  <small className="text-muted">Lista miast zostanie zaktualizowana</small>
                </li>
                <li className="mb-2">
                  <strong>3. Wyślij formularz:</strong><br />
                  <small className="text-muted">Przycisk zostanie włączony po wypełnieniu</small>
                </li>
                <li>
                  <strong>4. Sprawdź konsolę:</strong><br />
          ...
          <div className="row text-center">
            ...
            <div className="col-md-3">
              <h5 className="text-info">
                {Math.round(countriesData.reduce((sum, country) => sum + country.cities.length, 0) / countriesData.length)}
              </h5>
              <small className="text-muted">Średnio miast na kraj</small>
            </div>
            <div className="col-md-3">
      ...
      <div className="card mt-4">
        ...
        <div className="card-body">
          <p className="mb-0">
            ...
            <br />
            <code className="ml-1">{"{ country: \"Nazwa kraju\", city: \"Nazwa miasta\" }"}</code>
            <br />
