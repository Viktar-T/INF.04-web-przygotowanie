# EGZAMIN ZAWODOWY — INF.04 (INF.04-FEEDBACK-FORM-COUNTER)
...
Wykonaj aplikację internetową typu front-end obsługującą formularz opinii z licznikiem znaków z zastosowaniem dostępnego na stanowisku egzaminacyjnym frameworka Angular lub biblioteki React. Zastosuj bibliotekę Bootstrap do zdefiniowania stylu aplikacji.
...
![Obraz 1b](img/feedback-preview.png)

Na obrazie 1b przedstawiono działanie aplikacji przygotowanej w środowisku React.js, stan po wypełnieniu formularza i naciśnięciu przycisku "Wyślij opinię".
...
- Aplikacja web – dowolna liczba zrzutów nazwanych web1, web2 ... (np. stan początkowy, po wypełnieniu pól z poprawnymi danymi, po naciśnięciu "Wyślij opinię", po wprowadzeniu niepoprawnego emaila, po przekroczeniu limitu znaków, stan konsoli przeglądarki z wyświetlonymi komunikatami)
