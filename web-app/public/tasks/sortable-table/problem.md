# EGZAMIN ZAWODOWY — INF.04 (INF.04-SORTABLE-TABLE)
...
- Komponent wyświetla:
  - Nagłówek drugiego stopnia o treści: „Sortowalna tabela wyników"
...
- Aplikacja web – dowolna liczba zrzutów nazwanych web1, web2 ... (np. stan początkowy, po kliknięciu na kolumnę "Wynik", po kliknięciu ponownie na "Wynik" (zmiana kierunku), po kliknięciu na kolumnę "Nazwa", stan konsoli przeglądarki z wyświetlonymi komunikatami)
