...
function App() {
  ...
  const handleResetSort = () => {
    setSortField('name')
    setSortDirection('asc')
    console.log('Sort: field=name dir=asc')
  }
  ...
  const isDefaultSort = sortField === 'name' && sortDirection === 'asc'

  return (
    <div className="container mt-4">
      <h2 className="mb-4">Sortowalna tabela wyników (Zaawansowana)</h2>
          ...
          <div className="card">
            <div className="card-header d-flex justify-content-between align-items-center">
              ...
              <button
                ...
                title="Przywróć domyślne sortowanie (nazwa rosnąco)"
              >
                Resetuj sortowanie
              </button>
            </div>
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <div className="mb-3">
                ...
                <span className={`badge ${isDefaultSort ? 'badge-success' : 'badge-warning'}`}>
                  {isDefaultSort ? 'Domyślne' : 'Zmienione'}
                </span>
              </div>
              {!isDefaultSort && (
                <div className="alert alert-info alert-sm mb-0">
                  <small>
                    <strong>Wskazówka:</strong> Kliknij "Resetuj sortowanie" aby przywrócić domyślne sortowanie.
                  </small>
                </div>
              )}
            </div>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <ul className="list-unstyled mb-0">
                ...
                <li className="mb-2">
                  <strong>Resetuj sortowanie:</strong><br />
                  <small className="text-muted">Przywraca domyślne sortowanie (nazwa rosnąco)</small>
                </li>
                <li>
      ...
      <div className="card mt-4">
        ...
        <div className="card-body">
          <p className="mb-0">
            ...
            <br />
            <strong>Reset sortowania:</strong> Loguje <code>"Sort: field=name dir=asc"</code>
            <br />
